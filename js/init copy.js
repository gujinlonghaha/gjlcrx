    ...
    const initBox = () => {
            ...
            const html = `
                    <div id='rushToBuyBox'>
                        ...
                        <form id='formList'>
                            <div>活动开始时间</div>
                            <input type="text" id="g_startTime"  value="" placeholder="2021/04/07 10:08:00" />
                            ...
                            <div id="gjlBox">
                                <input type="text" id="gjlyzm"  value="" placeholder="输入验证码" />
                                <button id='gjlyzmBtn' type="button">点击确定获取开始按钮</button>
                            </div>
                            <div class="center">
                               <button id='rushToBuy'>开始运行</button>
                            </div>
                            <div class="center">
                            <button style='margin-left:5px' id='stop'>停止</button>
                            </div>
                        </form>
            ...
            const gjlyzm = document.querySelector('#gjlyzm')
            const gjlBox = document.querySelector('#gjlBox')
            const gjlyzmBtn = document.querySelector('#gjlyzmBtn')
            // 操作
